      ...
      <div class="row">
        <div class="col-md-6 col-lg-5 col-xl-12 mb-4 mb-md-0">
            <div class="card">
              ...
              <?php 
               $user = $users->where('id', $message->to_id)->first() ;
              
              ?>
               
                  <li class="p-2 border-bottom" style="">
                    <a href="{{route('user_message', $message->to_id)}}" class="d-flex justify-content-between">  {{--link--}}
                      <div class="d-flex flex-row">
                        ...
                        <div class="pt-1">
                          <p class="fw-bold mb-0" style="text-transform: capitalize" >{{$user->name . ' ' .$user->surname }} Merkezi</p>
