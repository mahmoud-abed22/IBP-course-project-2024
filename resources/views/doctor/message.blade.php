...
<h4 style="padding: 20px ; font-size: 22px; color: red; font-weight: 600; padding-left: 0;"><a href="{{route('messages')}}" style="color: red ; font-size:35px "><i class='bx bx-left-arrow-circle '></i></a> </h4>
                ...
                <li class="d-flex justify-content-end mb-4">
                  <div class="card w-50 ">
                    <div class="card-header d-flex justify-content-between p-2">
                      <p class="fw-bold mb-0" style="text-transform:capitalize">{{Auth::user()->name}} {{Auth::user()->surname}} Merkezi</p>
                    </div>
                    <div class="card-body">
                      <p class="mb-0">
                      {{$allmessage->message}} 
